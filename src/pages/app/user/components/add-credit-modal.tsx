      ...
      <DialogContent className="sm:max-w-[600px]">
        ...
        <form onSubmit={handleSubmit(onSubmit)}>
          <div className="grid grid-cols-1 gap-4 py-4">
            ...
            <div className="grid items-start gap-2">
              <Label htmlFor="amount" className="text-start flex items-center gap-2">
                Valor do crédito:
              ...
              <Input
                ...
                step="0.01"
                min="0"
                className={`${errors.amount && 'border border-red-400 placeholder:text-red-300'}`}
                {...register('amount', {
                  valueAsNumber: true,
                })}
              />
            ...
            <div className="grid items-start gap-2">
              <Label htmlFor="description" className="text-start flex items-center gap-2">
                Descrição:
                {errors.description && <InputMessage message={errors.description.message} />}
              </Label>
              <Input
                type="text"
                id="description"
                ...
                className={`${
                  errors.description && 'border border-red-400 placeholder:text-red-300'
                }`}
