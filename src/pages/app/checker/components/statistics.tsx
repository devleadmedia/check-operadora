...
export function Statistics({ stats, fileName, fileSize }: PhoneStatsModalProps) {
  ...
  const limitBarData = <T extends { quantidade: number }>(data: T[], labelKey: keyof T): T[] => {
  ...
  const statsData = useMemo((): PhoneStatsData => {
    ...
    const portabilidadeMoveis: PieChartData[] = [
      ...
      {
        name: 'Não Portados',
        value: (statsTyped.movel || 0) - (statsTyped.portado_movel || statsTyped.portado || 0),
      },
    ]
    ...
    const dddsMovelData =
      statsTyped.ddd_movel || (statsTyped.movel && !statsTyped.fixo ? statsTyped.ddd : null)
    ...
    const dddsFixoData =
      statsTyped.ddd_fixo || (statsTyped.fixo && !statsTyped.movel ? statsTyped.ddd : null)
    ...
    const ufsMovelData =
      statsTyped.uf_movel || (statsTyped.movel && !statsTyped.fixo ? statsTyped.uf : null)
    ...
    const ufsFixoData =
      statsTyped.uf_fixo || (statsTyped.fixo && !statsTyped.movel ? statsTyped.uf : null)
    ...
    const anoPortabilidadeMovelData =
      ...
      (statsTyped.movel && !statsTyped.fixo ? statsTyped.ano_portabilidade : null)
        ...
        <div className="space-y-6 mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="space-y-6">
              ...
              {/* UFs Móveis */}
              <div className="bg-card p-4 rounded-lg border-2 border-border">
                <h3 className="text-lg font-semibold mb-4 text-center text-card-foreground">UFs</h3>
              ...
              <div className="bg-card p-4 rounded-lg border-2 border-border">
                ...
                {temMoveis && statsData.portabilidadeMoveis.some((d) => d.value > 0) ? (
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie
                ...
                {temMoveis && statsData.anoPortabilidadeMoveis.length > 0 ? (
                  <ResponsiveContainer width="100%" height={300}>
                    <BarChart data={statsData.anoPortabilidadeMoveis}>
                      ...
                      <YAxis tick={LABEL_STYLE} />
                      <Tooltip content={<CustomTooltip />} />
                      <Bar dataKey="quantidade" fill="hsl(var(--chart-3))" radius={[8, 8, 0, 0]} />
                    </BarChart>
                  </ResponsiveContainer>
                ) : (
                  <div className="flex items-center justify-center h-[300px] text-muted-foreground">
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie
                        ...
                        dataKey="value"
                      >
                        {statsData.operadorasDoadorasMoveis.map((_entry, index) => (
                          <Cell
                            key={`cell-${index}`}
                            fill={`hsl(var(--chart-${(index % 5) + 1}))`}
                          />
              ...
              <div className="bg-card p-4 rounded-lg border-2 border-border">
                ...
                {temMoveis && statsData.operadorasReceptorasMoveis.length > 0 ? (
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie
                        ...
                        dataKey="value"
                      >
                        {statsData.operadorasReceptorasMoveis.map((_entry, index) => (
                          <Cell
                            key={`cell-${index}`}
                            fill={`hsl(var(--chart-${(index % 5) + 1}))`}
                          />
            ...
            <div className="space-y-6">
              ...
              <div className="bg-card p-4 rounded-lg border-2 border-border">
                ...
                {temFixos && statsData.portabilidadeFixos.some((d) => d.value > 0) ? (
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie
                        ...
                        dataKey="value"
                      >
                        {statsData.operadorasDoadorasFixos.map((_entry, index) => (
                          <Cell
                            key={`cell-${index}`}
                            fill={`hsl(var(--chart-${(index % 5) + 1}))`}
                          />
                  ...
                  <ResponsiveContainer width="100%" height={300}>
                    <PieChart>
                      <Pie
                        ...
                        dataKey="value"
                      >
                        {statsData.operadorasReceptorasFixos.map((_entry, index) => (
                          <Cell
                            key={`cell-${index}`}
                            fill={`hsl(var(--chart-${(index % 5) + 1}))`}
                          />
